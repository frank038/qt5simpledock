        ...
        if _data == None:
            ...
            if os.path.exists(_file):
                ...
                if _time2 > _current_time:
                    ...
                    if _t:
                        self.mytimer = QTimer()
                        self.mytimer.singleShot(_t*1000, self.on_set_timer)
